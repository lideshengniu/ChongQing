<template>
  <div class="container">
    <div class="container2">
      <ul class="left">
        <li class="word"><span class="title">广西高速公路智能监测预警平台</span></li>
        <ul class="function">
          <li class="functions">
            <span>综合分析示例</span>
    ...
    <el-dialog v-model="centerDialogVisible" title="是否退出" center class="note">
      <span class="message"> 你是否确定要退出？ </span>
      <template #footer>
        <span class="dialog-footer">
          <el-button @click="centerDialogVisible = false">取消</el-button>
          <el-button type="primary" @click="firm()"> 确认 </el-button>
        </span>
      </template>
    </el-dialog>
  </div>
