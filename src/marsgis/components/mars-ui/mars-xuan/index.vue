<template>
  <teleport to="#mars-main-view">
    <div class="pannel-box" :class="[customClass, animationClass, borders]" ref="pannelBox" v-show="mergeProps.visible">
...
.pannel-box {
  ...
  background-color: rgba(87, 161, 174, 0.121);
...
.borderss {
  border: solid 2px rgba(97, 211, 231, 0.791);
}
